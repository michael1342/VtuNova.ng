...
const LandingPage = () => {
  ...
  return (
    <div className="relative w-full">
      ...
      <header className={`fixed top-0 left-0 right-0 border-b border-border z-[1000] flex items-center transition-all duration-300 ${isScrolled ? 'h-[70px] bg-bg-dark/90 shadow-[0_10px_30px_rgba(0,0,0,0.1)]' : 'h-20 bg-bg-dark/70 backdrop-blur-lg'}`}>
        <div className="max-w-[1200px] w-full mx-auto px-6 flex justify-between items-center">
          ...
          <ul className="hidden min-[901px]:flex gap-8 list-none">
            ...
            <li><a href="#features" className="text-[0.95rem] font-medium text-text-gray hover:text-text-white">Services</a></li>
            <li><a href="#pricing" className="text-[0.95rem] font-medium text-text-gray hover:text-text-white">Pricing</a></li>
            <li><a href="#testimonials" className="text-[0.95rem] font-medium text-text-gray hover:text-text-white">About</a></li>
            <li><a href="#footer" className="text-[0.95rem] font-medium text-text-gray hover:text-text-white">Contact</a></li>
          </ul>
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="fixed top-20 left-0 right-0 bg-bg-dark-secondary border-b border-border p-6 flex flex-col gap-4 z-[999]">
          ...
          <a href="#pricing" className="text-[0.95rem] font-medium text-text-gray hover:text-text-white" onClick={() => setMobileMenuOpen(false)}>Pricing</a>
      ...
      {/* Stats Bar */}
      <section className="py-15 border-y border-border bg-bg-dark-secondary/10 relative z-10">
        <div className="max-w-[1200px] w-full mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-[30px] md:gap-10 text-center">
          <div>
            <div className="font-heading text-[2.8rem] font-bold text-text-white mb-2 text-gradient-blue text-gradient-blue">150M+</div>
            <div className="text-[0.85rem] uppercase tracking-wider text-text-gray">Transactions</div>
          </div>
          <div>
            <div className="font-heading text-[2.8rem] font-bold text-text-white mb-2 text-gradient-purple text-gradient-purple">10K+</div>
            <div className="text-[0.85rem] uppercase tracking-wider text-text-gray">Active Clients</div>
          </div>
          <div>
            <div className="font-heading text-[2.8rem] font-bold text-text-white mb-2" style={{ color: 'var(--color-accent-green)' }}>99.9%</div>
            <div className="text-[0.85rem] uppercase tracking-wider text-text-gray">Uptime SLA</div>
          </div>
          <div>
            <div className="font-heading text-[2.8rem] font-bold text-text-white mb-2" style={{ color: 'var(--color-accent-orange)' }}>100+</div>
            <div className="text-[0.85rem] uppercase tracking-wider text-text-gray">Supported Nations</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-25 relative" id="features">
        ...
        <div className="max-w-[1200px] w-full mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Feature 1 */}
            <div className="bg-bg-dark-secondary/60 border border-border backdrop-blur-md rounded-2xl transition-all duration-300 hover:border-border-hover hover:-translate-y-0.5 dark:hover:shadow-[0_12px_30px_rgba(0,0,0,0.4),0_0_20px_rgba(59,130,246,0.05)] hover:shadow-xl bg-bg-card border border-border p-8 text-left group">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6 bg-bg-dark-secondary/50 border border-border text-primary group-hover:scale-110 group-hover:rotate-5 group-hover:border-border-hover transition-all duration-300" style={{ color: 'var(--color-accent-cyan)' }}>
            ...
            {/* Feature 2 */}
            <div className="bg-bg-dark-secondary/60 border border-border backdrop-blur-md rounded-2xl transition-all duration-300 hover:border-border-hover hover:-translate-y-0.5 dark:hover:shadow-[0_12px_30px_rgba(0,0,0,0.4),0_0_20px_rgba(59,130,246,0.05)] hover:shadow-xl bg-bg-card border border-border p-8 text-left group">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6 bg-bg-dark-secondary/50 border border-border text-primary group-hover:scale-110 group-hover:rotate-5 group-hover:border-border-hover transition-all duration-300" style={{ color: 'var(--color-accent-green)' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* Feature 3 */}
            <div className="bg-bg-dark-secondary/60 border border-border backdrop-blur-md rounded-2xl transition-all duration-300 hover:border-border-hover hover:-translate-y-0.5 dark:hover:shadow-[0_12px_30px_rgba(0,0,0,0.4),0_0_20px_rgba(59,130,246,0.05)] hover:shadow-xl bg-bg-card border border-border p-8 text-left group">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6 bg-bg-dark-secondary/50 border border-border text-primary group-hover:scale-110 group-hover:rotate-5 group-hover:border-border-hover transition-all duration-300" style={{ color: 'var(--color-accent-purple)' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* Feature 4 */}
            <div className="bg-bg-dark-secondary/60 border border-border backdrop-blur-md rounded-2xl transition-all duration-300 hover:border-border-hover hover:-translate-y-0.5 dark:hover:shadow-[0_12px_30px_rgba(0,0,0,0.4),0_0_20px_rgba(59,130,246,0.05)] hover:shadow-xl bg-bg-card border border-border p-8 text-left group">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6 bg-bg-dark-secondary/50 border border-border text-primary group-hover:scale-110 group-hover:rotate-5 group-hover:border-border-hover transition-all duration-300" style={{ color: 'var(--color-primary)' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* Feature 5 */}
            <div className="bg-bg-dark-secondary/60 border border-border backdrop-blur-md rounded-2xl transition-all duration-300 hover:border-border-hover hover:-translate-y-0.5 dark:hover:shadow-[0_12px_30px_rgba(0,0,0,0.4),0_0_20px_rgba(59,130,246,0.05)] hover:shadow-xl bg-bg-card border border-border p-8 text-left group">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6 bg-bg-dark-secondary/50 border border-border text-primary group-hover:scale-110 group-hover:rotate-5 group-hover:border-border-hover transition-all duration-300" style={{ color: 'var(--color-accent-orange)' }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <section className="py-25 bg-bg-dark-secondary/10 border-y border-border relative overflow-hidden">
        <div className="max-w-[1200px] w-full mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 lg:gap-20 gap-15 items-center">
          <div className="text-left">
            ...
            <div className="grid grid-cols-1 min-[481px]:grid-cols-2 gap-6">
              <div className="flex flex-col gap-3 p-4 bg-bg-card border border-border rounded-xl">
                <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ background: 'var(--color-accent-purple-glow)', color: 'var(--color-accent-purple)' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect>
                    <path d="M7 11V7a5 5 0 0 1 10 0v4"></path>
                  </svg>
                </div>
                <h3 className="text-[1rem] font-bold text-text-white">Enterprise Security</h3>
                <p className="text-[0.85rem] text-text-gray leading-[1.4]">Bank-grade security controls and double-ledger validation systems.</p>
              </div>

              <div className="flex flex-col gap-3 p-4 bg-bg-card border border-border rounded-xl">
                <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ background: 'var(--color-accent-green-glow)', color: 'var(--color-accent-green)' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <circle cx="12" cy="12" r="10"></circle>
                ...
                <h3 className="text-[1rem] font-bold text-text-white">Global Coverage</h3>
                <p className="text-[0.85rem] text-text-gray leading-[1.4]">Connecting to over 600 telecommunications providers globally.</p>
              </div>

              <div className="flex flex-col gap-3 p-4 bg-bg-card border border-border rounded-xl">
                <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ background: 'var(--color-primary-glow)', color: 'var(--color-primary)' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <line x1="12" y1="1" x2="12" y2="23"></line>
                    <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>
                  </svg>
                </div>
                <h3 className="text-[1rem] font-bold text-text-white">Instant Settlements</h3>
                <p className="text-[0.85rem] text-text-gray leading-[1.4]">Every transaction is accounted for and settled into your wallet instantly.</p>
              </div>

              <div className="flex flex-col gap-3 p-4 bg-bg-card border border-border rounded-xl">
                <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ background: 'var(--color-accent-cyan-glow)', color: 'var(--color-accent-cyan)' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"></path>
                  </svg>
                </div>
                <h3 className="text-[1rem] font-bold text-text-white">Easy Setup</h3>
                <p className="text-[0.85rem] text-text-gray leading-[1.4]">Obtain access credentials and deploy key transactions in 10 minutes.</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center items-center relative">
            <div className="absolute w-[350px] h-[350px] bg-[radial-gradient(circle,rgba(59,130,246,0.1)_0%,transparent_70%)] -z-10 pointer-events-none" />
            <div className="w-[290px] h-[580px] bg-bg-card border-[10px] border-zinc-700 dark:border-zinc-800 rounded-[40px] shadow-[0_30px_60px_rgba(0,0,0,0.15)] relative overflow-hidden flex flex-col animate-float">
      ...
      <section className="py-25 relative">
        <div className="max-w-[1200px] w-full mx-auto px-6">
          ...
          <div className="grid grid-cols-1 min-[581px]:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-8 md:px-6 text-center relative group">
              <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-6 font-heading text-[1.1rem] font-bold text-text-white border border-border relative z-10 group-hover:border-primary group-hover:shadow-[0_0_15px_rgba(59,130,246,0.15)] transition-all duration-300" style={{ borderColor: 'var(--color-primary)', color: 'var(--color-primary)' }}>1</div>
            ...
            <div className="p-8 md:px-6 text-center relative group">
              <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-6 font-heading text-[1.1rem] font-bold text-text-white border border-border relative z-10 group-hover:border-primary group-hover:shadow-[0_0_15px_rgba(59,130,246,0.15)] transition-all duration-300" style={{ borderColor: 'var(--color-accent-green)', color: 'var(--color-accent-green)' }}>2</div>
            ...
            <div className="p-8 md:px-6 text-center relative group">
              <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-6 font-heading text-[1.1rem] font-bold text-text-white border border-border relative z-10 group-hover:border-primary group-hover:shadow-[0_0_15px_rgba(59,130,246,0.15)] transition-all duration-300" style={{ borderColor: 'var(--color-accent-purple)', color: 'var(--color-accent-purple)' }}>3</div>
            ...
            <div className="p-8 md:px-6 text-center relative group">
              <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-6 font-heading text-[1.1rem] font-bold text-text-white border border-border relative z-10 group-hover:border-primary group-hover:shadow-[0_0_15px_rgba(59,130,246,0.15)] transition-all duration-300" style={{ borderColor: 'var(--color-accent-orange)', color: 'var(--color-accent-orange)' }}>4</div>
      ...
      <section className="py-25" id="testimonials">
        <div className="max-w-[1200px] w-full mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Card 1 */}
            <div className="bg-bg-dark-secondary/60 border border-border backdrop-blur-md rounded-2xl transition-all duration-300 hover:border-border-hover hover:-translate-y-0.5 dark:hover:shadow-[0_12px_30px_rgba(0,0,0,0.4),0_0_20px_rgba(59,130,246,0.05)] hover:shadow-xl p-8 text-left">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-[0.95rem] font-semibold text-white">Amara Okafor</span>
            ...
            <div className="bg-bg-dark-secondary/60 border border-border backdrop-blur-md rounded-2xl transition-all duration-300 hover:border-border-hover hover:-translate-y-0.5 dark:hover:shadow-[0_12px_30px_rgba(0,0,0,0.4),0_0_20px_rgba(59,130,246,0.05)] hover:shadow-xl p-8 text-left">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-[0.95rem] font-semibold text-white">David Beckham</span>
            ...
            <div className="bg-bg-dark-secondary/60 border border-border backdrop-blur-md rounded-2xl transition-all duration-300 hover:border-border-hover hover:-translate-y-0.5 dark:hover:shadow-[0_12px_30px_rgba(0,0,0,0.4),0_0_20px_rgba(59,130,246,0.05)] hover:shadow-xl p-8 text-left">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-[0.95rem] font-semibold text-white">Sarah Lewis</span>
      ...
      {/* Pricing Section */}
      {/*<section className="py-25 border-t border-border bg-white/[0.01] relative" id="pricing">
        <div className="max-w-[1200px] w-full mx-auto px-6">
          <div style={{ textAlign: 'center' }}>
            <div className="section-tag">PRICING</div>
            <h2 className="section-title">Simple, Transparent Pricing</h2>
            <p className="section-desc">
              Choose the perfect plan to scale your transactions. No setup costs, no hidden utility fees.
            </p>

              Toggle Switch
            <div className="flex justify-center items-center gap-4 mb-[50px]">
              <span className={`text-[0.95rem] transition-colors duration-200 ${billingPeriod === 'monthly' ? 'text-white font-semibold' : 'text-text-gray font-medium'}`}>Monthly</span>
              <button 
                className={`w-[50px] h-[26px] rounded-full border relative transition-colors duration-200 cursor-pointer ${billingPeriod === 'annual' ? 'bg-primary border-primary/35' : 'bg-white/8 border-border'}`}
                onClick={() => setBillingPeriod(billingPeriod === 'monthly' ? 'annual' : 'monthly')}
                aria-label="Toggle Billing Frequency"
              >
                <div className={`w-[18px] h-[18px] bg-white rounded-full absolute top-[3px] left-[3px] transition-transform duration-200 cubic-bezier(0.4, 0, 0.2, 1) ${billingPeriod === 'annual' ? 'translate-x-6' : 'translate-x-0'}`} />
              </button>
              <span className={`text-[0.95rem] transition-colors duration-200 ${billingPeriod === 'annual' ? 'text-white font-semibold' : 'text-text-gray font-medium'}`}>
                Annually
                <span className="bg-accent-green/15 border border-accent-green/30 text-accent-green text-[0.75rem] font-bold px-2 py-0.5 rounded-full ml-2">Save 20%</span>
              </span>
            </div>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-7 items-stretch lg:max-w-none max-w-[480px] mx-auto">
            Starter Plan
            <div className="bg-bg-dark-secondary/60 border border-border backdrop-blur-md rounded-2xl transition-all duration-300 hover:border-border-hover hover:-translate-y-0.5 dark:hover:shadow-[0_12px_30px_rgba(0,0,0,0.4),0_0_20px_rgba(59,130,246,0.05)] hover:shadow-xl p-10 flex flex-col relative text-left">
              <span className="text-[1.15rem] text-white mb-2">Starter</span>
              <p className="text-[0.85rem] text-text-muted mb-6 leading-[1.4]">Best for exploring custom dashboard tools, personal top-ups and test utility payments.</p>
              <div className="flex items-baseline gap-1 mb-8 border-b border-border pb-6">
                <span className="font-heading text-[2.75rem] font-bold text-white">$0</span>
                <span className="text-[0.9rem] text-text-muted">/ forever</span>
              </div>
              <ul className="flex flex-col gap-4 list-none mb-10 grow">
                <li className="flex items-center gap-3 text-[0.9rem] text-text-gray">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-accent-green shrink-0">
                    <polyline points="20 6 9 17 4 12"></polyline>
                  </svg>
                  Demo Dashboard Simulations
                </li>
                <li className="flex items-center gap-3 text-[0.9rem] text-text-gray">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-accent-green shrink-0">
                    <polyline points="20 6 9 17 4 12"></polyline>
                  </svg>
                  Send Airtime & Data Packs
                </li>
                <li className="flex items-center gap-3 text-[0.9rem] text-text-gray">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-accent-green shrink-0">
                    <polyline points="20 6 9 17 4 12"></polyline>
              ...
              <button className="border border-border text-white text-[0.95rem] font-semibold px-[22px] py-[10px] rounded-lg hover:bg-white/5 hover:border-border-hover transition-all duration-200 mt-auto w-full">Create Free Account</button>
            </div>

            Growth Plan
            <div className="bg-bg-dark-secondary/60 border border-border backdrop-blur-md rounded-2xl transition-all duration-300 hover:border-border-hover hover:-translate-y-0.5 dark:hover:shadow-[0_12px_30px_rgba(0,0,0,0.4),0_0_20px_rgba(59,130,246,0.05)] hover:shadow-xl p-10 flex flex-col relative text-left border-primary shadow-[0_20px_40px_rgba(59,130,246,0.1)]">
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-primary text-white text-[0.75rem] font-bold px-4 py-1 rounded-full uppercase tracking-wider">RECOMMENDED</div>
              <span className="text-[1.15rem] text-white mb-2">Growth</span>
              <p className="text-[0.85rem] text-text-muted mb-6 leading-[1.4]">Perfect for active users, growing startups, and utility management businesses.</p>
              <div className="flex items-baseline gap-1 mb-8 border-b border-border pb-6">
                <span className="font-heading text-[2.75rem] font-bold text-white">
                  ${billingPeriod === 'monthly' ? '49' : '39'}
                </span>
                <span className="text-[0.9rem] text-text-muted">/ month</span>
              </div>
              <ul className="flex flex-col gap-4 list-none mb-10 grow">
                <li className="flex items-center gap-3 text-[0.9rem] text-text-gray">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-accent-green shrink-0">
                ...
                <li className="flex items-center gap-3 text-[0.9rem] text-text-gray">
                  ...
                  Full Access to All Utility Dispatches
                </li>
                <li className="flex items-center gap-3 text-[0.9rem] text-text-gray">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-accent-green shrink-0">
                    <polyline points="20 6 9 17 4 12"></polyline>
              ...
              <button className="bg-primary text-white text-[0.95rem] font-semibold px-[22px] py-[10px] rounded-lg shadow-[0_4px_14px_rgba(59,130,246,0.4)] hover:bg-primary-hover hover:-translate-y-[1px] hover:shadow-[0_6px_20px_rgba(59,130,246,0.5)] transition-all duration-200 mt-auto w-full">Get Started Now</button>
            </div>

            Enterprise Plan
            <div className="bg-bg-dark-secondary/60 border border-border backdrop-blur-md rounded-2xl transition-all duration-300 hover:border-border-hover hover:-translate-y-0.5 dark:hover:shadow-[0_12px_30px_rgba(0,0,0,0.4),0_0_20px_rgba(59,130,246,0.05)] hover:shadow-xl p-10 flex flex-col relative text-left">
              <span className="text-[1.15rem] text-white mb-2">Enterprise</span>
              <p className="text-[0.85rem] text-text-muted mb-6 leading-[1.4]">For high-volume corporations, digital banks, and enterprise utility users.</p>
              <div className="flex items-baseline gap-1 mb-8 border-b border-border pb-6">
                <span className="font-heading text-[2.75rem] font-bold text-white" style={{ fontSize: '2.4rem' }}>Custom</span>
                <span className="text-[0.9rem] text-text-muted">/ volume-based</span>
              </div>
              <ul className="flex flex-col gap-4 list-none mb-10 grow">
                <li className="flex items-center gap-3 text-[0.9rem] text-text-gray">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-accent-green shrink-0">
              ...
              <button className="border border-border text-white text-[0.95rem] font-semibold px-[22px] py-[10px] rounded-lg hover:bg-white/5 hover:border-border-hover transition-all duration-200 mt-auto w-full">Contact Sales</button>
            </div>
          </div>
        </div>
      </section>
 ...
 */}      {/* Call To Action Banner */}
      <section className="pt-20 pb-25 relative z-10">
        <div className="max-w-[1200px] w-full mx-auto px-6">
          <div className="bg-gradient-to-br from-bg-dark-secondary/80 via-primary/8 to-accent-purple/8 border border-border rounded-[24px] py-[60px] px-10 text-center relative overflow-hidden dark:shadow-[0_30px_60px_rgba(0,0,0,0.4)] shadow-xl">
            ...
            <div className="flex flex-col min-[481px]:flex-row justify-center gap-4 min-[481px]:items-center max-[480px]:px-5">
              ...
              <button className="border border-border text-text-white text-[0.95rem] font-semibold px-[22px] py-[10px] rounded-lg hover:bg-bg-dark hover:border-border-hover transition-all duration-200">Contact Support</button>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 min-[481px]:grid-cols-2 min-[901px]:grid-cols-[1.5fr_1fr_1fr_1fr] gap-10 min-[901px]:gap-[60px] mb-15">
            <div className="flex flex-col items-start gap-4">
              ...
              <div className="flex gap-3">
                <a href="#" className="w-9 h-9 rounded-lg bg-white/3 border border-border flex items-center justify-center text-text-gray hover:bg-white/8 hover:text-white hover:border-border-hover transition-all duration-200" aria-label="GitHub">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
                  </svg>
                </a>
                <a href="#" className="w-9 h-9 rounded-lg bg-white/3 border border-border flex items-center justify-center text-text-gray hover:bg-white/8 hover:text-white hover:border-border-hover transition-all duration-200" aria-label="Twitter">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path>
                  </svg>
                </a>
                <a href="#" className="w-9 h-9 rounded-lg bg-white/3 border border-border flex items-center justify-center text-text-gray hover:bg-white/8 hover:text-white hover:border-border-hover transition-all duration-200" aria-label="LinkedIn">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3 list-none text-left">
                ...
                <li><a href="#pricing" className="text-text-gray hover:text-white transition-colors duration-200 inline-block">Pricing Plans</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-3 list-none text-left">
                ...
                <li><a href="#" className="text-text-gray hover:text-white transition-colors duration-200 inline-block">User Dashboard</a></li>
